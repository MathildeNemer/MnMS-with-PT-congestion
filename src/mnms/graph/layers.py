...
from mnms.vehicles.veh_type import Vehicle, Car, Bus, Bike
...
class BikeLayer(SimpleLayer):
    def __init__(self,
                 roads: RoadDescriptor,
                 _id: str = "BIKE",
                 veh_type = Bike,
                 default_speed: float = 15,
                 services: Optional[List[AbstractMobilityService]] = None,
                 observer: Optional = None):
        super(BikeLayer, self).__init__(roads, _id, Bike, default_speed, services, observer)
