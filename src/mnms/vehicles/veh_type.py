    ...
    def next_activity(self, tcurrent: Time):
        ...
        if activity.activity_type is not ActivityType.STOP:
            if activity.path:
                ...
                print(self._current_node, " --- ", self._current_link)
                if self.mobility_service != 'WALKING':
                ...
                # The condition for setting activity to done should depend on the activity type
...
class Car(Vehicle):
    def __init__(self,
        ...
        super(Car, self).__init__(node, capacity, mobility_service, is_personal, is_public_transport, activities)
...
class Bus(Vehicle):
    def __init__(self,
                 ...
                 activities: Optional[VehicleActivity] = None):
        super(Bus, self).__init__(node, capacity, mobility_service, is_personal, is_public_transport, activities)
...
class Tram(Vehicle):
    def __init__(self,
                 ...
                 is_public_transport=True,
                 activities: Optional[VehicleActivity] = None):
        super(Tram, self).__init__(node, capacity, mobility_service, is_personal, is_public_transport, activities)
...
class Metro(Vehicle):
    def __init__(self,
                 ...
                 is_public_transport = True,
                 activities: Optional[VehicleActivity] = None):
        super(Metro, self).__init__(node, capacity, mobility_service, is_personal, is_public_transport, activities)
...
class Bike(Vehicle):
    def __init__(self,
                 ...
                 is_public_transport=False,
                 activities: Optional[VehicleActivity] = None):
        super(Bike, self).__init__(node, capacity, mobility_service, is_personal, is_public_transport, activities)
...
class Walking(Vehicle):
    def __init__(self,
                 ...
                 is_public_transport=False,
                 activities: Optional[VehicleActivity] = None):
        super(Walking, self).__init__(node, capacity, mobility_service, is_personal, is_public_transport, activities)
...
class Train(Vehicle):
    def __init__(self,
                 ...
                 is_public_transport=True,
                 activities: Optional[VehicleActivity] = None):
        super(Train, self).__init__(node, capacity, mobility_service, is_personal, is_public_transport, activities)
