...
if __name__=='__main__':
    ...
    ### BARCELONA - WITH CAR TRAFFIC ###
    if fluct_cong:
        SCENARIO = f"Barcelona"
        ...
        MOB_SERVICES_PARAMS = {
            "PT_STOPS": {"BUS": fake_barcelona_bus_stops,
                         "TRAM": fake_barcelona_tram_stops},
    ...
    ### BARCELONA - ALL METHODS - EFFECTS OF PT CONGESTION NO CAR - LT=1 ###
    if basic:
        SCENARIO = "Barcelona"
    ...
    ### BARCELONA - ALL METHODS - SHARP PEAK HOUR - LT =1 ###
    if sharp_peak:
        SCENARIO = "Barcelona"
        ...
        for n_users in [1300, 2600]:  # [200, 1300, 2600]:
    ...
    ### BARCELONA - DYNAMIC - LT TEST EXHAUSTIVE - TC CAPA x2 ###
    if exhaustive_lt:
        SCENARIO = "Barcelona"
